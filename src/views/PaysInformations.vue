<template>
    <main class="container-fluid">
        ...
        <div class="d-flex flex-wrap">
            <div v-for="country in filteredCountries" :key="country?.translations?.fra.common" class="flag-item"
...
export default {
    ...
    methods: {
        async fetchCountries() {
            try {
                const response = await axios.get('https://restcountries.com/v3.1/all?translations');
